...
- [OfflineActionQueue](OfflineActionQueue/): encola acciones cuando falla la red y las reintenta en orden con persistencia local, ideal para UX resiliente en conectividad inestable.
